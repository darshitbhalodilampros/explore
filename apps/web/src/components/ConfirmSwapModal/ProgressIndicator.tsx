  ...
  const stepDetails: Record<ProgressIndicatorStep, StepDetails> = useMemo(
    () => ({
      [ConfirmModalState.WRAPPING]: {
        ...
        actionRequiredTitle: t(`Wrap  {{symbol}} in wallet`, {
          symbol: nativeCurrency.symbol,
        }),
        inProgressTitle: t(`Wrapping  {{symbol}}...`, {
          symbol: nativeCurrency.symbol,
        }),
        learnMoreLinkText: t(`Why do I have to wrap my {{symbol}}?`, {
          symbol: nativeCurrency.symbol,
        }),
      ...
      [ConfirmModalState.RESETTING_TOKEN_ALLOWANCE]: {
        icon: <CurrencyLogo currency={trade?.inputAmount.currency} />,
        rippleColor: inputTokenColor,
        previewTitle: t(`Reset {{symbol}} limit`, {
          symbol: trade?.inputAmount.currency.symbol,
        }),
        actionRequiredTitle: t(`Reset {{symbol}} limit in wallet`, {
          symbol: trade?.inputAmount.currency.symbol,
        }),
        inProgressTitle: t(`Resetting {{symbol}} limit...`, {
          symbol: trade?.inputAmount.currency.symbol,
        }),
      },
      [ConfirmModalState.APPROVING_TOKEN]: {
        icon: <CurrencyLogo currency={trade?.inputAmount.currency} />,
        rippleColor: inputTokenColor,
        previewTitle: t(`Approve {{symbol}} spending`, {
          symbol: trade?.inputAmount.currency.symbol,
        }),
